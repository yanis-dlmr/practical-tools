...
<h4> The website is divided into 1 categories for the moment: </h4>
• A tool to handle <a class="custom-link" href="/pictures">Pictures</a> and do treatments on them 

<h4> Disclaimer </h4>
The tools are still in development, some features may not work properly. If you encounter any problems, please contact us.
`
...
<img src="/src/assets/images/logo.ico" alt="logo" style="width: 100%; height: auto; margin-top: 1rem; margin-bottom: 1rem;">
    ...
    `
Please take a look at the documentation before using the tools and to have further informations.
    `
